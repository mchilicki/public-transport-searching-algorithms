...
namespace Chilicki.Ptsa.Benchmarks
{
    ...
    public class SingleCriteriaDijkstraVsMultipleCriterionDijkstra
    {
        ...
        public IEnumerable<SearchInputDto> Searches { get; set; } = new List<SearchInputDto>()
        {
            ...
            new SearchInputDto() { StartStopId = new Guid("666d08c1-42f8-424c-9e78-df929600f4b4"), DestinationStopId = new Guid("7e8363b2-4e6a-45bc-b276-72bfc2279cf7"), StartTime = TimeSpan.Parse("14:00:00") },
            new SearchInputDto() { StartStopId = new Guid("50d19f91-7223-4603-9c6a-500847b42e30"), DestinationStopId = new Guid("3817248e-ffd1-48d8-818b-0ed9ca3bde47"), StartTime = TimeSpan.Parse("10:00:00") },
            new SearchInputDto() { StartStopId = new Guid("c9835234-011e-4719-b5da-8070864a54ff"), DestinationStopId = new Guid("568c9b9e-2739-4c86-a57c-3ad44a8bcea5"), StartTime = TimeSpan.Parse("11:00:00") },
        };

        [Params(60, 120, 180, 240, 360, 480)]
