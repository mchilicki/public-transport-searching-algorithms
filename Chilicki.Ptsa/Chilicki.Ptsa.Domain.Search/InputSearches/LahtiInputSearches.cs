...
namespace Chilicki.Ptsa.Domain.InputSearches
{
    public static class LahtiInputSearches
    {
        public static IEnumerable<SearchInputDto> Searches { get; set; } = new List<SearchInputDto>()
        {
            ...
            new SearchInputDto() { StartStopId = new Guid("7b4f15b4-3308-43d3-96f5-e0f49ffc5759"), DestinationStopId = new Guid("5fafb1d9-aecc-4470-8635-ab23ba62f32b"), StartTime = TimeSpan.Parse("11:42:00") },
            ...
            new SearchInputDto() { StartStopId = new Guid("f8b056e1-e720-4751-93a8-21635e183198"), DestinationStopId = new Guid("12402b9e-4377-4a44-99e8-e76751fd9a6e"), StartTime = TimeSpan.Parse("12:41:00") },
            new SearchInputDto() { StartStopId = new Guid("9df86d05-0a98-4553-8f69-47e21aca6545"), DestinationStopId = new Guid("8397134b-a45a-438b-9b97-4b3f93d1c240"), StartTime = TimeSpan.Parse("14:58:00") },
            ...
            new SearchInputDto() { StartStopId = new Guid("adebde90-1cfa-4a16-b5c6-7bff15e7d342"), DestinationStopId = new Guid("7b4f15b4-3308-43d3-96f5-e0f49ffc5759"), StartTime = TimeSpan.Parse("11:09:00") },
            new SearchInputDto() { StartStopId = new Guid("5fb44569-6dec-476d-b19a-9a3231a3bfde"), DestinationStopId = new Guid("cb14098a-c1ee-4a1c-a9ac-06c28036759b"), StartTime = TimeSpan.Parse("14:18:00") },
            ...
            new SearchInputDto() { StartStopId = new Guid("54181b95-27a4-4ec2-bf9c-6a112bb23ff7"), DestinationStopId = new Guid("0d2b5b44-48fd-481c-a510-03b8a2228d30"), StartTime = TimeSpan.Parse("16:13:00") },
            ...
            new SearchInputDto() { StartStopId = new Guid("2307aa82-4f29-4768-b6d5-21584b041c9f"), DestinationStopId = new Guid("87521f13-c227-4439-8163-afb61651349c"), StartTime = TimeSpan.Parse("15:59:00") },
            new SearchInputDto() { StartStopId = new Guid("aae2c3e1-1211-4ea6-9224-4b357ebe8526"), DestinationStopId = new Guid("fd5ae881-f6c5-4df6-b930-5ef5e7439cba"), StartTime = TimeSpan.Parse("13:05:00") },
            ...
            new SearchInputDto() { StartStopId = new Guid("943b6215-a242-48cb-a7cb-e6b1294556ca"), DestinationStopId = new Guid("18918f0c-acd8-41d4-9175-7504a018381b"), StartTime = TimeSpan.Parse("16:27:00") },
